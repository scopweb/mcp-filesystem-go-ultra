...
func TestRunRipgrepSearch_PatternFlagInjection(t *testing.T) {
	...
	matches, err := engine.RunRipgrepSearch(context.Background(), dir, "--pre=calc", false, false, false, 0, false, nil)
	if err != nil {
...
func TestRunRipgrepSearch_DashPattern(t *testing.T) {
	...
	matches, err := engine.RunRipgrepSearch(context.Background(), dir, "--verbose", false, false, false, 0, false, nil)
	if err != nil {
...
func TestRunRipgrepSearch_SkipDirs(t *testing.T) {
	...
	matches, err := engine.RunRipgrepSearch(context.Background(), dir, "needle", false, false, false, 0, false, nil)
	if err != nil {
...
func TestRunRipgrepSearch_ArgvConstruction(t *testing.T) {
	...
	if _, err := engine.RunRipgrepSearch(context.Background(), dir, "--pre=calc", false, false, false, 0, false, nil); err != nil {
