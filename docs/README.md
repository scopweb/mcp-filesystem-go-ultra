...
- [AI_AGENT_INSTRUCTIONS.md](ai-integration/AI_AGENT_INSTRUCTIONS.md) - Instructions for AI agents
- [INITIAL_PROMPT_FOR_AI.md](ai-integration/INITIAL_PROMPT_FOR_AI.md) - Initial prompt template
- [SYSTEM_PROMPT_COMPACT.txt](ai-integration/SYSTEM_PROMPT_COMPACT.txt) - Compact system prompt
